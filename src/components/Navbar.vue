<template>
  <Disclosure as="nav" class="bg-gray-900 fixed w-screen z-50" v-slot="{ open }">
    <div class="mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
              ...
              <Menu as="div" class="relative ml-3">
                ...
                <a href="#" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">My
                  Events</a>
                    ...
                    <a href="/#/chiefpatrons"
                      :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-50 hover:text-gray-900 ']">Chief
                      Patron</a>
                    </MenuItem>
                    <MenuItem v-slot="{ active }">
                    <a href="/#/patronsadvisors"
                      :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-50 hover:text-gray-900 ']">Patrons
                      & Advisors</a>
                    </MenuItem>
                    <MenuItem v-slot="{ active }">
                    <a href="/#/conveners"
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <!-- Profile dropdown -->
          <Menu as="div" class="relative ml-3" v-if="authStore.isAuth">
            <div>
              <MenuButton
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                  stroke="currentColor" class="h-8 w-8 rounded-full text-gray-50">
            ...
            <transition enter-active-class="transition ease-out duration-100"
              ...
              <MenuItems
                ...
                <a href="/#/profile"
                  :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">Profile</a>
                </MenuItem>
                <MenuItem v-slot="{ active }">
    ...
    <DisclosurePanel class="sm:hidden">
      <div class="px-2 pb-3 pt-2 flex justify-evenly">
