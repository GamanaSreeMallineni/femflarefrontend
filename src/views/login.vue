    ...
    <section class="h-screen bg-gray-900 flex items-center justify-center">
        <div class="w-full h-3/2 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            <div class="px-6 py-4">
                ...
                <p class="mt-1 text-center text-gray-500 dark:text-gray-400">Embrace the Blooms of Femininity</p>
                <p class="text-center" :class="messageColor">{{ message }}</p>
                <h3 class="mt-2 text-xl font-medium text-center text-gray-600 dark:text-gray-200">Login</h3>
            ...
            <div class="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
                ...
                <a href="/#/signup"
                    class="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline">Signup here</a>
            </div>
        </div>
    </section>
